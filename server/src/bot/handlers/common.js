...
/** Главное меню: зависит от роли и того, прошёл ли житель регистрацию. */
...
/** Запуск бота: /start, кнопка «Начать» или переход по ссылке https://max.ru/<бот>?start=<payload>. */
...
export function registerCommonHandlers(bot) {
