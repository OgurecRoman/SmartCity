...
/**
 * Отправка заявки в ответственную организацию.
 * Без SMTP_HOST отправка имитируется: письмо пишется в лог (это явно отмечается в ответе бота).
 */
export async function sendDelegationEmail(request, organization, document) {
